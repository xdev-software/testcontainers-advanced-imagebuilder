...
class AdvancedImageFromDockerfileTest extends AbstractBuildTest
{
	...
	void simpleCheck()
	{
		...
		final AdvancedImageFromDockerFile builder = this.configureDefault(
			new AdvancedImageFromDockerFile("dynamically-built"));
